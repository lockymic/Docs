...
By downloading, installing, or using Sudoku ("the app"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the app.
...
- In-app purchases (hints, ad removal)
...
- **Monthly Subscription:** $0.99/month (auto-renewable)
- **Yearly Subscription:** $4.99/year (auto-renewable)
- **Lifetime Purchase:** $9.99 (one-time, non-consumable)
...
- We do not have access to payment information or refund controls
...
### 5.1 Consumable Purchases
- **Hint Bundle:** $0.99 for 10 hints
- Hints are consumed when used
- No refunds for unused hints if you delete the app

### 5.2 Restore Purchases
- Non-consumable purchases and active subscriptions can be restored
...
- Upload offensive usernames or content
...
- After providing notice within the app
...
- You agree to comply with Apple's Terms of Service

**Google Play Store Additional Terms:**
- You acknowledge that these Terms are between you and us, not Google
- Google is not responsible for the app or its content
- Google has no obligation to provide support

---

By using Sudoku, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
